...
export default function Header(){
    return (
        <header className="w-full bg-gradient-to-br from-inherit to-black flex flex-row  items-center align-middle justify-around">
            <svg className="h-16 w-16 md:h-20 md:w-20 lg:w-20 lg:h-20 shadow-sm hover:scale-110 transition duration-300 cursor-pointer"
            ...
            <ul className="flex  font-sans font-light text-sm lg:text-lg cursor-pointer  ">
                <li className="mx-4 pt-1 md:pt-2 lg:mx-9 hover:scale-105 hover:line-through duration-150  ease-in-out"><Link href="/">About</Link></li>
                <li className="mx-4 pt-1 md:pt-2 lg:mx-9 hover:scale-105 hover:line-through duration-150  ease-in-out" ><Link href="/"></Link>Projects</li>
                <li className="mx-4 pt-1 md:pt-2 lg:mx-9 hover:scale-105 hover:line-through duration-150  ease-in-out" ><Link href="/"></Link>Contact</li>
