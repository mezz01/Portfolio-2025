...
export default function Footer(){
    return (
        <footer className="relative z-50 Projects mt-16 h-full pt-1 bg-slate-200 text-BrandPurple  rounded-t-3xl" >
        ...
        <section className="socials absolute bottom-5 ">
            <ul className="flex flex-row justify-around items-center md:text-xl ">
                <li className="m-2"><Link href="/">
