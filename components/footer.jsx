    ...
    return (
        ...
        <section className="flex flex-col justify-around items-end mb-3 mt-10">
            <div className="flex flex-col justify-around gap-5 md:flex-row w-full md:justify-between ">
                ...
                <a className="text-sm md:text-xl lg:text-2xl font-thin border border-black p-2 ml-4 rounded-3xl bg-BrandPurple/70 font-serif hover:scale-110 duration-200 transition-transform" href="mailto:mezzatamine2002@gmail.com">med.amine.mezzat@gmail.com</a>
