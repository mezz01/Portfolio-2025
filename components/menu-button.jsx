        ...
        <div className="flex flex-col">
            ...
            >
                <ul className={`h-96 w-64 top-0 font-sans font-light text-sm lg:text-lg cursor-pointer transition-transform duration-500`}>
                    ...
                    <li><a href="/CV.pdf" download=""><button  className="text-2xl mx-4 pt-4 mt-10 lg:mx-9 hover:scale-110 hover:underline duration-150  ease-in-out" onClick={() => {Toggle()}}>See my resume</button></a></li>
                </ul>
            </motion.div>
        </div>
