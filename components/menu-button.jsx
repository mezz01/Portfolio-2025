        ...
        <div className="flex flex-col">
            ...
            >
                <ul className={`h-96 w-64 top-0 font-sans font-light text-sm lg:text-lg cursor-pointer transition-transform duration-500`}>
                    ...
                    <li><Link href="/contact"><button  className="text-6xl mx-4 pt-4 lg:mx-9 text-gray-400" onClick={() => {Toggle()}} >Blog <span className=" text-xs">coming soon ...</span></button></Link></li>
