stroke="#9C4DC1" stroke-width="20" stroke-linecap="round"/>
          <path d="M328.054 51.7305C328.054 59.1414 330.155 66.1393 330.787 73.4061C331.176 77.8868 331.154 82.4091 331.687 86.8835C332.338 92.3542 331.339 99.0384 333.085 104.274" stroke="#9C4DC1" stroke-width="20" stroke-linecap="round"/>
          <path d="M334.761 50.6126C337.009 54.305 340.545 56.8744 343.332 60.1151C345.538 62.6801 347.09 65.6437 348.86 68.4996C351.558 72.8527 354.029 77.0673 356.561 81.4802C359.164 86.0164 362.996 90.3181 363.952 95.5786C364.548 98.8554 365.021 102.263 366.064 105.392" stroke="#9C4DC1" stroke-width="20" stroke-linecap="round"/>
          <path d="M366.064 105.392C366.064 93.6666 365.505 81.9819 365.505 70.2697C365.505 63.306 364.821 56.1129 365.319 49.1841C365.858 41.6782 369.734 32.3751 374.014 26.1421C377.972 20.3762 382.323 13.6576 389.385 11.4847C392.883 10.4084 401.914 8.76569 404.633 11.4847" stroke="#9C4DC1" stroke-width="20" stroke-linecap="round"/>
          <path d="M395.689 47.2588C395.689 60.2388 393.757 72.5267 391.342 85.2066C390.449 89.8917 389.541 94.5103 389.541 99.274C389.541 99.7073 389.648 105.176 390.658 103.156" stroke="#9C4DC1" stroke-width="20" stroke-linecap="round"/>
          <path d="M397.925 43.9049C402.687 42.5443 406.88 38.148 411.465 36.0794C414.322 34.7898 418.024 33.0314 421.184 32.7566C426.175 32.3226 431.211 28.7731 435.935 31.6076" stroke="#9C4DC1" stroke-width="20" stroke-linecap="round"/>
          <path d="M397.366 70.7355C404.565 70.2213 411.655 68.7415 418.886 68.4686C422.582 68.3291 425.624 66.2637 429.227 66.2637" stroke="#9C4DC1" stroke-width="20" stroke-linecap="round"/>
          <path d="M397.925 102.038C408.386 102.038 418.719 99.8019 429.227 99.8019" stroke="#9C4DC1" stroke-width="20" stroke-linecap="round"/>
  ...
  <div className="Tech mt-auto md:mb-16 lg:mb-20">
    <div className="relative flex overflow-x-hidden ">
      <div className="py-9 animate-marquee whitespace-nowrap">
        ...
        <span className="text-2xl lg:text-4xl mx-6">REACT</span>
        <span className="text-2xl lg:text-4xl mx-6 bg-gray-400 px-3 blur-lg rounded-full">*</span>
        <span className="text-2xl lg:text-4xl mx-6">NEXT.JS</span>
        <span className="text-2xl lg:text-4xl mx-6 bg-gray-400 px-3 blur-lg rounded-full">*</span>
        <span className="text-2xl lg:text-4xl mx-6">TAILWIND</span>
        <span className="text-2xl lg:text-4xl mx-6 bg-gray-400 px-3 blur-lg rounded-full">*</span>
        <span className="text-2xl lg:text-4xl mx-6">REDUX</span>
        <span className="text-2xl lg:text-4xl mx-6 bg-gray-400 px-3 blur-lg rounded-full">*</span>
        <span className="text-2xl lg:text-4xl mx-6">GIT/GITHUB</span>
        <span className="text-2xl lg:text-4xl mx-6 bg-gray-400 px-3 blur-lg rounded-full">*</span>
        <span className="text-2xl lg:text-4xl mx-6">EXPRESS.JS</span>
        <span className="text-2xl lg:text-4xl mx-6 bg-gray-400 px-3 blur-lg rounded-full">*</span>
        <span className="text-2xl lg:text-4xl mx-6">FIREBASE</span>
        <span className="text-2xl lg:text-4xl mx-6 bg-gray-400 px-3 blur-lg rounded-full">*</span>
        <span className="text-2xl lg:text-4xl mx-6">SHADCN-UI</span>
        <span className="text-2xl lg:text-4xl mx-6 bg-gray-400 px-3 blur-lg rounded-full">*</span>
      </div>
